pro write_bias_ghost_matrix_as_spectral_library, input_image_filename, detector_positions_filename
...
envi_write_envi_file, transposed_l8_matrix, file_type=envi_file_type(file_type), out_name='L8_ghost_matrix.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = l8_header, bname=['SCA-B Det100']
